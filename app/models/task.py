class Task:
    ...
    def load_all():
        raw_data = [
            # === Moduł 1: Zmienne ===
            (1, "Stwórz dowolną zmienną i przypisz do niej liczbę 10.", "x = 10", "code_input", None),
            (1, "Stwórz zmienną i przypisz do niej tekst 'Olek' (pamiętaj o cudzysłowach).",
             'imie = "Olek"', "code_input", None),
            (1, "Utwórz dwie różne zmienne: jedną z wartością 3, a drugą z wartością 7.", "a = 3\nb = 7", "code_input", None),
            (1, "Stwórz zmienną o wartości 5, a następnie w kolejnej linii zwiększ jej wartość o 2.",
            ...
            # === Moduł 2: Warunki ===
            (2,
             "Stwórz zmienną o wartości 7. Sprawdź instrukcją warunkową, czy jest większa od 5. Jeśli tak, wypisz tekst 'Duże'.",
             "x = 7\nif x > 5:\n    print('Duże')", "code_input", None),
            (2, "Stwórz zmienną równą 10. Jeśli jest ona równa 10, wypisz tekst 'Dziesięć'.",
             "y = 10\nif y == 10:\n    print('Dziesięć')", "code_input", None),
            (2, "Stwórz zmienną o wartości 3. Jeśli jest mniejsza niż 5, wypisz tekst 'Mała liczba'.",
             "liczba = 3\nif liczba < 5:\n    print('Mała liczba')", "code_input", None),
            (2, "Stwórz zmienną równą 0. Jeśli jest mniejsza od 10, wypisz 'Zimno', w przeciwnym razie ('else') wypisz 'Ciepło'.",
            ...
            (3,
             "Stwórz zmienną sumującą (np. `suma`) ustawioną na 0. Następnie pętlą `for` dodaj do niej liczby od 1 **do 5**. Na końcu wypisz wynik.",
            ...
            # === Moduł 4: Funkcje ===
            (4, "Zdefiniuj funkcję (np. `przywitaj`), która nie przyjmuje argumentów i wypisuje 'Cześć!'. Następnie **wywołaj ją**.",
             "def przywitaj():\n    print('Cześć!')\nprzywitaj()", "code_input", None),
            (4,
             "Napisz funkcję `dodaj(a, b)`, która zwraca sumę dwóch liczb. Następnie wypisz wynik dodawania 5 i 5.",
             "def dodaj(a, b):\n    return a + b\nprint(dodaj(5, 5))", "code_input", None),
            (4,
             "Stwórz funkcję, która wypisuje tekst 'Python' 3 razy (w pętli). Nie zapomnij jej wywołać.",
             "def wypisz_python():\n    for i in range(3):\n        print('Python')\nwypisz_python()", "code_input", None),
            (4,
             "Napisz funkcję `powitanie(imie)`, która wypisuje 'Cześć, ' + imie. Wywołaj ją dla imienia 'Ania'.",
             "def powitanie(imie):\n    print('Cześć, ' + imie)\npowitanie('Ania')", "code_input", None),
            ...
            # === Moduł 5: Listy ===
            (
            5, "Stwórz listę zawierającą liczby 1, 2 i 3.", "liczby = [1, 2, 3]", "code_input", None),
            (5, "Stwórz listę `[1, 2, 3]`. Dodaj do niej element 4 **na koniec**.",
             "liczby = [1, 2, 3]\nliczby.append(4)", "code_input", None),
            (5, "Utwórz **pustą** listę.", "dane = []", "code_input", None),
            (5,
             "Masz listę `[5, 10, 15]`. Używając pętli `for`, wypisz **każdy element** tej listy w osobnej linii.",
