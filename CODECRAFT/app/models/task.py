class Task:
    ...
    def load_all():
        raw_data = [
            ...
            (1, "Zadeklaruj zmienną 'imie' i przypisz do niej swoje imię", 'imie = "Kuba"', "code_input", None),
            (1, "Utwórz dwie zmienne a i b, przypisz im wartości 3 i 7", "a = 3\nb = 7", "code_input", None),
            (1, "Zmienna x ma wartość 5. Zwiększ ją o 2.", "x = 5\nx = x + 2", "code_input", None),
            (1,
            ...
            (2, "Jaki będzie wynik?\n\nif False:\n    print('Pierwsze')\nelse:\n    print('Drugie')", "Drugie",
             "code_output", None),
            (3, "Napisz pętlę, która wypisze liczby od 0 do 4", "for i in range(5):\n    print(i)", "code_input", None),
            (3, "Napisz pętlę while, która wypisze liczby od 1 do 3", "i = 1\nwhile i <= 3:\n    print(i)\n    i += 1",
             "code_input", None),
            (3, "Wypisz 'Cześć' 3 razy za pomocą pętli", "for i in range(3):\n    print('Cześć')", "code_input", None),
            (3, "Zlicz sumę liczb od 1 do 5", "suma=0\nfor i in range(1, 6):\n    suma+=i\n    print(suma)",
             "code_input", None),
            ...
            (4, "Napisz funkcję dodaj, która zwraca sumę dwóch liczb a i b", "def dodaj(a, b):\n    return a + b",
             "code_input", None),
            (4, "Stwórz funkcję, która wypisuje 'Python' 3 razy",
             "def wypisz():\n    for i in range(3):\n        print('Python')", "code_input", None),
            (4, "Napisz funkcję, która przyjmuje imię i wypisuje powitanie",
            ...
            (5, "Utwórz listę zawierającą liczby 1, 2 i 3", "lista = [1, 2, 3]", "code_input", None),
