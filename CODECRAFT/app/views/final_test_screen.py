...
class FinalTestScreen(QWidget):
    def __init__(self, main_window, lesson_index):
        ...
        self.test_tasks = random.sample(self.tasks, 10)
        self.current_index = 0
        self.correct_answers = 0
        self.remaining_time = 300
        self.user_progress = self.main_window.user_progress
        self.user_answers = []
    ...
    def init_ui(self):
        ...
        # Timer
        self.timer_label = QLabel("Czas: 300 sek")
    ...
    def update_timer(self):
        ...
        self.timer_label.setText(f"Czas: {self.remaining_time} sek")
    ...
    def load_task(self):
        ...
        # Set question
        self.question_label.setText(f"Pytanie {self.current_index + 1}/10:\n\n{task.question}")
    ...
    def check_answer(self):
        ...
        if task.type == "code_input":
            ...
            correct_lines = correct_answer.strip().splitlines()
            user_lines = user_answer.splitlines()
            is_correct = [line.strip() for line in user_lines] == [line.strip() for line in correct_lines]
    ...
    def end_test(self, timeout=False):
        ...
        summary_html = generate_summary_html(self.user_answers, self.correct_answers)
        ...
        if self.correct_answers >= 8:
            try:
                ...
                self.user_progress.complete_task(task_id=task_id, lesson_index=self.lesson_index)
                result_msg = "Test zdany! Moduł zaliczony."
            except Exception as e:
                print(f"Błąd podczas zapisywania postępu: {e}")
                result_msg = "Test zdany! (Problem z zapisem postępu)"
        else:
            result_msg = "Test niezaliczony. Spróbuj ponownie."
        ...
        if self.correct_answers >= 8:
            ...
            self.main_window.show_menu()  # Odśwież menu