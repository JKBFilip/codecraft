...
class FinalTestScreen(QWidget):
    ...
    def end_test(self, timeout=False):
        ...
        test_result = {
            ...
            "time": float(elapsed_time),  # Zapewniamy float
        ...
        if new_achievements:  # Sprawdź czy są jakieś nowe osiągnięcia
            self.main_window.show_achievement_notification(new_achievements)  # Przekaż całą listę
