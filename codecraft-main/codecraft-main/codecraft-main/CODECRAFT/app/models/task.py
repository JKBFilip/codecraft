    ...
    def load_all():
        raw_data = [
            ...
            (1, "Zadeklaruj zmienną o nazwie `imie` i przypisz do niej **tekst** 'Olek' (użyj cudzysłowów)",
             'imie = "Olek"', "code_input", None),  # AST zignoruje ' vs "
            ...
            (2, "Ułóż kod: 1. `liczba = 0`, 2. jeśli `liczba == 0`, 3. wypisz 'Zero'.",
             "liczba = 0\nif liczba == 0:\n    print('Zero')", "reorder",
             ["liczba = 0", "if liczba == 0:", "    print('Zero')"]),  # Dodano wcięcie w opcji
            (2,
            ...
            (3,
             ...
             "suma = 0\nfor i in range(1, 6):\n    suma += i\nprint(suma)", "code_input", None),  # Poprawione polecenie
            ...
            (3, "Jak **natychmiastowo** zakończyć bieżącą iterację pętli i przejść do następnej?", "C",
             "multiple_choice", ["A: break", "B: stop", "C: continue", "D: next"]),  # Zmienione pytanie
            ...
            (3, "Ułóż kod, który pętlą `for` wypisuje liczby 0, 1, 2.", "for i in range(3):\n    print(i)", "reorder",
             ["for i in range(3):", "    print(i)"]),  # Dodano wcięcie w opcji
            (3, "Ułóż kod z `while`, który wypisuje liczby 1, 2, 3.", "i = 1\nwhile i <= 3:\n    print(i)\n    i += 1",
             "reorder", ["while i <= 3:", "    print(i)", "i = 1", "    i += 1"]),  # Dodano wcięcia w opcjach
            (3, "Ułóż pętlę `for`, która wypisze 3 razy 'wow'.", "for i in range(3):\n    print('wow')", "reorder",
             ["    print('wow')", "for i in range(3):"]),  # Dodano wcięcie w opcji
            (3, "Ułóż kod: 1. `suma=0`, 2. pętla `for` od 1 do 3, 3. w pętli `suma += i`, 4. po pętli wypisz `suma`.",
             "suma = 0\nfor i in range(1, 4):\n    suma += i\nprint(suma)", "reorder",
             ["suma = 0", "for i in range(1, 4):", "    suma += i", "print(suma)"]),  # Dodano wcięcie w opcji
            ...
            (4,
             ...
             "def powitanie(imie):\n    print('Cześć, ' + imie)", "code_input", None),  # Alternatywnie f-string
            ...
            (5,
             ...
             "elementy = [5, 10, 15]\nfor x in elementy:\n    print(x)", "code_input", None),  # Sprecyzowane polecenie
            ...
            (5, "Jak usunąć **pierwsze wystąpienie** elementu o wartości 2 z listy `lista`?", "B", "multiple_choice",
             ["A: remove(lista, 2)", "B: lista.remove(2)", "C: del lista[2]", "D: lista.delete(2)"]),  # Sprecyzowane
